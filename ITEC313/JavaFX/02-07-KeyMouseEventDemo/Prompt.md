...
Issue with the key event demo 

Operation:
- Click on the "Key Event Demo" tab
- The text "A" will automatically receive keyboard focus (you'll see it highlighted
...
actual behaviour:
- Press arrow keys key toggle between the two tabs: "mouse event demo" and "key event demo". 
...
https://liveexample.pearsoncmg.com/html/MouseEventDemo.html
...
package name: com.acu.javafx.keymouseeventdemo
