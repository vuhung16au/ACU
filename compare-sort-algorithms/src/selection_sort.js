/**
 * Selection Sort implementation in JavaScript with performance measurement.
 */
...
// Main function
function main() {
    console.log("JavaScript Selection Sort Performance Test");
    console.log("=========================================");
    ...
    const results = `JavaScript Selection Sort Results\n` +
