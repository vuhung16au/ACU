...
Create a beginner-friendly advanced unit testing sample that reuses a simple Razor Pages form and introduces a mocked dependency for duplicate-email checking.
...
10. `Email` must be checked against an email registry for duplicates.
...
16. The solution must include unit tests for validation, result processing, and mocked dependency interactions.
...
- Use one mockable interface for the advanced concept.
...
- The tests pass and clearly show both logic and interaction testing.
