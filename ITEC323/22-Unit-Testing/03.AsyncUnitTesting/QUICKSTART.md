...
```bash
cd 22-Unit-Testing/03.AsyncUnitTesting
dotnet run
```
...
```bash
cd 22-Unit-Testing/03.AsyncUnitTesting/tests/03.AsyncUnitTesting.Tests
dotnet restore
dotnet build
dotnet test
```
...
5. interaction with the mocked async email registry
