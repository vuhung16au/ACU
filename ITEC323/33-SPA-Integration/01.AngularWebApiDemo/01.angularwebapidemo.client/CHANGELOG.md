...
- Create Angular project with ng: `ng new _01.angularwebapidemo.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`_01.angularwebapidemo.client.esproj`).
