...
/// <summary>
/// Holds the starter content returned to the Angular app on first load.
/// </summary>
public class SpaModuleOverview
{
    /// <summary>
    /// Gets or sets the title displayed in the Angular page header.
    /// </summary>
    ...
    /// <summary>
    /// Gets or sets the checklist shown in the Angular page.
    /// </summary>
