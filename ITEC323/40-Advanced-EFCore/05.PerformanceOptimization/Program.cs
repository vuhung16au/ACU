...
builder.Services.AddDbContext<AppDbContext>(options =>
{
    var connectionString = builder.Configuration.GetConnectionString("DefaultConnection")
        ?? "Host=localhost;Port=55432;Database=advanced_efcore_performance;Username=advanced_efcore_user;Password=advanced_efcore_password";
...
builder.Services.AddScoped<PerformanceLabService>();
