...
namespace _01.ReactWebApiDemo.Server.Controllers;

/// <summary>
/// Exposes a small JSON API that the React frontend can call while students
/// learn how ASP.NET Core works with a modern frontend library.
/// </summary>
[ApiController]
...
public class SpaIntegrationController : ControllerBase
{
    ...
    /// <summary>
    /// Returns the starter content shown when the React app first loads.
    /// </summary>
    ...
    /// <returns>A guided response that the React app can render.</returns>
