...
public class RagAnswerService
{
    ...
    /// </summary>
    /// <param name="knowledgeBaseService">Provides the local knowledge base documents.</param>
    /// <param name="keywordSearchService">Finds relevant documents for a question.</param>
    /// <param name="textGenerationService">Generates the final answer.</param>
    /// <param name="options">Provides retrieval settings.</param>
