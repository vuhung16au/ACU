...
```bash
cd 10.AndroidKotlinJetpackCompose/06.ComprehensiveApp
```
...
```bash
adb shell am start -n com.acu.comprehensiveapp/.MainActivity
```

## What To Check
- The welcome screen opens the student list
