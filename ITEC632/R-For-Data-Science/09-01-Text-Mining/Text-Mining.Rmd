---
title: "Text Mining on 2016 U.S. Presidential Race"
output:
  html_document:
    toc: true
    toc_depth: 3
...
knitr::opts_chunk$set(echo = TRUE, message = FALSE, warning = FALSE, fig.align = "center", fig.width = 8, fig.height = 5, dev.args = list(bg = "white"))
```

## Overview

This document demonstrates basic text mining in R using speeches, debates, and primary texts from the 2016 U.S. Presidential race. It mirrors the concepts from the reference notebook and covers:
...
We also briefly explain what text mining is, common formats, and typical NLP operators.
...
```{r ngrams-plots, fig.width=10, fig.height=6}
