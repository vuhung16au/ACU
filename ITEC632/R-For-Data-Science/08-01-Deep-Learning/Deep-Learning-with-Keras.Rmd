...
imgs <- c(
  "fig01_limit_bal.png",
  "fig01b_limit_bal_overlay.png",
  "fig02_gender.png",
  "fig03_education.png",
  "fig04_marriage.png",
  "fig05_age.png",
  "fig06_payment_status.png",
  "fig07_bill_amount.png",
  "fig08_prev_payment.png",
  "fig09_correlation_heatmap.png",
  "fig10_training_history.png",
  "fig11_roc.png"
)
for (f in imgs) {
  cat("\n### ", f, "\n\n", sep = "")
  print(knitr::include_graphics(file.path("images", f)))
}
```
